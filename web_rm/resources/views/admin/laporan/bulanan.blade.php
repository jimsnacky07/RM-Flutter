                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-6">
                            <div class="bg-success bg-opacity-10 rounded p-3">
                                <h4 class="text-success fw-bold">Rp {{ number_format($totalPendapatan ?? 0, 0, ',', '.') }}</h4>
                                                    ...
                                                    @foreach($pesanan->detailPesanan as $detail)
                                                        <div class="d-flex align-items-center mb-1">
                                                            ...
                                                            <span class="fw-medium">
                                                                ...
                                                                <span class="badge bg-info">{{ $detail->jumlah ?? 1 }}</span>
                                                            </span>
                                                        </div>
                                                    @endforeach
                                                @else
                    ...
                    @else
                        <div class="text-center text-muted py-5">
                            <div class="py-4">
                                ...
                                <p class="text-muted">
                                    @if(request('bulan') && request('tahun'))
                                        Pilih bulan dan tahun yang berbeda atau belum ada transaksi pada periode tersebut
                                    @else
...
function exportToExcel() {
    ...
    link.setAttribute('download', 'laporan_bulanan_{{ request("bulan") ?? "" }}_{{ request("tahun") ?? "" }}.csv');
