            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.menus.update', $menu->id ?? 0) }}" method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="nama" name="nama"
                                    ...
                                    placeholder="Masukkan nama menu" value="{{ old('nama', $menu->nama ?? '') }}" required>
                                @error('nama')
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="stok" name="stok"
                                    ...
                                    placeholder="Masukkan jumlah stok" value="{{ old('stok', $menu->stok ?? '') }}"
                                    min="0">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="kategori" id="kategori" class="form-control">
                                        ...
                                        <option value="Makanan Berat"
                                            {{ $menu->kategori == 'Makanan Berat' ? 'selected' : '' }}>Makanan Berat
                                        </option>
                                        <option value="Makanan Ringan"
                                            {{ $menu->kategori == 'Makanan Ringan' ? 'selected' : '' }}>Makanan Ringan
                                        </option>
                                        <option value="Minuman Panas"
                                            {{ $menu->kategori == 'Minuman Panas' ? 'selected' : '' }}>Minuman Panas
                                        </option>
                                        <option value="Minuman Dingin"
                                            {{ $menu->kategori == 'Minuman Dingin' ? 'selected' : '' }}>Minuman Dingin
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-text">
                                        ...
                                        Format yang didukung: JPG, PNG, GIF. Maksimal 2MB. Biarkan kosong jika tidak ingin
                                        mengganti gambar.
                                    </div>
                                    @error('gambar')
                                        <div class="invalid-feedback">
