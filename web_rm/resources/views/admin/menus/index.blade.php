                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="position-relative">
                                    <img src="{{ asset('images/menus/' . $menu->gambar) }}"
                                        ...
                                        data-bs-target="#imageModal{{ $menu->id }}"
                            ...
                            <td>
                                <span class="badge bg-success fs-6">Rp {{ number_format($menu->harga, 0, ',', '.') }}</span>
                            </td>
                            <td>
                                @if($menu->kategori)
...
@if($menu->gambar)
<div class="modal fade" id="imageModal{{ $menu->id }}" tabindex="-1" aria-labelledby="imageModalLabel{{ $menu->id }}">
...
<div class="modal fade" id="deleteModal{{ $menu->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $menu->id }}">
