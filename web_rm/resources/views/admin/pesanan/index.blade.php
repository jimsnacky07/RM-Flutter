                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="badge bg-{{ $statusColors[$pesanan->status] ?? 'secondary' }}">
                                        <i class="fas fa-{{ $statusIcons[$pesanan->status] ?? 'question' }} me-1"></i>
                                        {{ $pesanan->status == 'pending' ? 'Menunggu Konfirmasi' : $pesanan->status }}
                                    </span>
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" 
                                                ...
                                                data-bs-target="#deleteModal{{ $pesanan->id }}"
                                                title="Hapus Pesanan">
