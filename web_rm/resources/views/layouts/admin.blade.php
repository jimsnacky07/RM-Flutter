                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="{{ route('admin.pengguna.index') }}">
                                    <i class="fas fa-users me-2"></i>Pengguna
                                </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.menus.index') }}">
                                    <i class="fas fa-utensils me-2"></i>Menu
                                </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.pesanan.index') }}">
                                    <i class="fas fa-shopping-cart me-2"></i>Pesanan
                                </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.laporan.bulanan') }}">
                                    <i class="fas fa-chart-bar me-2"></i>Laporan Bulanan
                                </a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.laporan.tahunan') }}">
