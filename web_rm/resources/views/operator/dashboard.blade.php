                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="fas fa-table me-2"></i>Meja</th>
                                    ...
                                    @forelse($pesananTerbaru ?? [] as $index => $p)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                <span
                                                    class="badge bg-{{ $statusColors[$p->status ?? 'pending'] ?? 'secondary' }}">
                                                    <i
                                                        class="fas fa-{{ $statusIcons[$p->status ?? 'pending'] ?? 'question' }} me-1"></i>
                                                    {{ $p->status ?? 'Pending' }}
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-center text-muted py-5">
                                                <div class="py-4">
                                                    ...
                                                    <p class="text-muted">Pesanan akan muncul di sini setelah pelanggan
                                                        melakukan order</p>
                                                </div>
                                            </td>
                                        </tr>
